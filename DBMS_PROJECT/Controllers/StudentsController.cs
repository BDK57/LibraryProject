...
namespace DBMS_PROJECT.Controllers
{
    ...
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentID,StudentName,FatherName,CNIC,PhoneNumber,DepartmentID")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentID,StudentName,FatherName,CNIC,PhoneNumber,DepartmentID")] Student student)
        {
            if (ModelState.IsValid)
            {
